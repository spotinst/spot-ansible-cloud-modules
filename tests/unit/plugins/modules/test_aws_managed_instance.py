...
from ansible_collections.spot.cloud_modules.plugins.modules.aws_managed_instance import turn_to_model
...
class TestTurnToModel(unittest.TestCase):
    ...
    def test_all_fields(self):
        ...
        mi = turn_to_model(module.params, "managed_instance")
        # test name
        ...
        record_set = Route53RecordSetConfiguration(name="some_name", use_public_ip=True, use_public_dns=None)
